...
```
![Generate Secure String](/web-database-server/17.generate-secure-string.png)
...
![Edit phpMyAdmin Configuration](/web-database-server/18.edit-phpmyadmin-configuration.png)

Sehingga menjadi.
![Edit phpMyAdmin Configuration](/web-database-server/18.edit-phpmyadmin-configuration-after.png)
...
```
![Change phpMyAdmin Config Permission](/web-database-server/19.change-phpmyadmin-config-permission.png)

20. Ubah ownership folder phpMyAdmin dengan command
```sh
chown -R www-data:www-data /var/www/html/phpMyAdmin
```
![Change phpMyAdmin Config Permission](/web-database-server/20.change-phpmyadmin-ownership.png)
...
23. Tes Dengan Menggunakan Browser
    ...
    ![Address Bar phpMyAdmin](/web-database-server/23.1.check-phpmyadmin-browser.png)
    3. Pastikan muncul seperti ini
    ![Login Page phpMyAdmin](/web-database-server/23.2.check-phpmyadmin-browser.png)
    4. Loginkan dengan username `root` & password mariadb [yang telah disetting](#mariadbpass)
    ![Login Page phpMyAdmin](/web-database-server/23.3.check-phpmyadmin-browser.png)
    5. Apabila sukses maka akan muncul seperti ini
    ![Dashboard phpMyAdmin](/web-database-server/23.4.check-phpmyadmin-browser.png)